...
import createRecords from '@salesforce/apex/UserRecordController.createRecords';

export default class UserInputRecord extends LightningElement {
    @track currentStep = 1;
